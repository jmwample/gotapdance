...
type ClientToStation struct {
	...
	// Client Conf version -> used to signal to the station what decoy ip blocks are supported
	ClientConfV *uint32 `protobuf:"varint,23,opt,name=client_conf_v,json=clientConfV" json:"client_conf_v,omitempty"`
...
func (m *ClientToStation) GetClientConfV() uint32 {
	if m != nil && m.ClientConfV != nil {
		return *m.ClientConfV
	}
	return 0
}
...
var fileDescriptor_39f66308029891ad = []byte{
	...
	,
}
